                                ...
                                <div class="col">
                                    <form  method="post" action="<?= site_url('karyawan/save'); ?>">
                                        ...
                                        <select class="form-select" name="posisi">
                                            <option selected value='null'>Pilih posisi...</option>
                                            <?php foreach ($posisi as $row) {?>
                                                 <option value="<?= $row->id_upah?>"><?= $row->Posisi?></option>";
                                            <?php }?>
                                        </select>
                                        <label class="form-label">Domisili</label>
                                        <input class="form-control" type="text" placeholder="Domisili" name="domisili">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <button class="btn btn-primary float-end" type="submit" style="width: 127.1625px;height: 43px;margin: 17px;">Submit</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
